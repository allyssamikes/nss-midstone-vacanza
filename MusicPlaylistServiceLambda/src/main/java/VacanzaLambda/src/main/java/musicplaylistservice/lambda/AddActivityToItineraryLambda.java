...
//        implements RequestHandler<com.nashss.se.musicplaylistservice.lambda.AuthenticatedLambdaRequest<AddActivityToItineraryRequest>, com.nashss.se.musicplaylistservice.lambda.LambdaResponse> {
//
//    /**
